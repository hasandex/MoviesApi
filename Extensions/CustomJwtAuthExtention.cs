...
namespace MoviesApi.Extensions
{
    ...
    //this code sets up JWT-based authentication for an ASP.NET Core application
    //configuring the necessary options and settings to validate the JWT tokens received from clients.
